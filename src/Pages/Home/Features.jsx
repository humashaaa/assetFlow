  ...
  return (
    <div>
      <Header
        title={"Features"}
        subtitle={
          "Explore the powerful features of AssetFlow designed to enhance your asset management efficiency and security."
        }
      ></Header>
      ...
      <div className="grid grid-cols-2 gap-6 pl-36  pt-28 pb-20">
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              Real-time tracking of asset status, location, and user
              assignments.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              Employees can request returnable or non-returnable assets via the
              platform.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              View records of damaged, lost, or returned items per employee for
              accountability.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              Design workflows tailored to company-specific asset management
              processes.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              Allow businesses to define their own asset categories - returnable
              and non-returnable.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-4 ">
          ...
          <div className="text-start py-3">
            ...
            <p className="text-gray-500 w-4/5">
              Record and monitor the condition of assets during check-out and
              return.
            </p>
          </div>
        </div>
